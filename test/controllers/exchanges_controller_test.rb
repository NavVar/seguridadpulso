...
class ExchangesControllerTest < ActionController::TestCase
  ...
  test "should create exchange" do
    assert_difference('Exchange.count') do
      post :create, exchange: { buy_value: @exchange.buy_value, rateclass_id: @exchange.rateclass_id, ratetype_id: @exchange.ratetype_id, to_date: @exchange.to_date }
    end
  ...
  test "should update exchange" do
    patch :update, id: @exchange, exchange: { buy_value: @exchange.buy_value, rateclass_id: @exchange.rateclass_id, ratetype_id: @exchange.ratetype_id, to_date: @exchange.to_date }
    assert_redirected_to exchange_path(assigns(:exchange))
  end
